...
typedef void (*pcc_action_t)(pelmish_context_t *, pcc_thunk_t *, pcc_value_t *);
...
typedef pcc_thunk_chunk_t *(*pcc_rule_t)(pelmish_context_t *);
...
static pelmish_context_t *pcc_context__create(pcc_auxil_t auxil) {
    pelmish_context_t *const ctx = (pelmish_context_t *)PCC_MALLOC(auxil, sizeof(pelmish_context_t));
    ctx->pos = 0;
    ctx->cur = 0;
    ctx->level = 0;
...
static void pcc_context__destroy(pelmish_context_t *ctx) {
    if (ctx == NULL) return;
...
static size_t pcc_refill_buffer(pelmish_context_t *ctx, size_t num) {
...
MARK_USED_FUNC
static void pcc_commit_buffer(pelmish_context_t *ctx) {
...
MARK_USED_FUNC
static const char *pcc_get_capture_string(pelmish_context_t *ctx, const pcc_capture_t *capt) {
    if (capt->string == NULL)
...
static size_t pcc_get_char_as_utf32(pelmish_context_t *ctx, int *out) { /* with checking UTF-8 validity */
    int c, u;
    size_t n;
...
MARK_USED_FUNC
static pcc_bool_t pcc_apply_rule(pelmish_context_t *ctx, pcc_rule_t rule, pcc_thunk_array_t *thunks, pcc_value_t *value) {
...
MARK_USED_FUNC
static void pcc_do_action(pelmish_context_t *ctx, const pcc_thunk_array_t *thunks, pcc_value_t *value) {
    size_t i;
...
static void pcc_action_parsable_0(pelmish_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
...
static void pcc_action_unparsable_0(pelmish_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
#define _0s ((const size_t)(__pcc_ctx->pos + __pcc_in->data.leaf.capt0.range.start))
...
static void pcc_action_functionDefinition_0(pelmish_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
#define _0s ((const size_t)(__pcc_ctx->pos + __pcc_in->data.leaf.capt0.range.start))
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_file(pelmish_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_parsable(pelmish_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_unparsable(pelmish_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_functionDefinition(pelmish_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_expression(pelmish_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_identifier(pelmish_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_literal(pelmish_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_delimitedComment(pelmish_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_lineComment(pelmish_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule__(pelmish_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_WS(pelmish_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_NL(pelmish_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_Non_NL(pelmish_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_Non_WS(pelmish_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_EOF(pelmish_context_t *ctx);
        ...
        size_t q;
        {
            ...
            for (i = 0;; i++) {
                ...
                const size_t n = chunk->thunks.len;
                {
                    const size_t p = ctx->cur;
                    const size_t n = chunk->thunks.len;
                    if (!pcc_apply_rule(ctx, pcc_evaluate_rule_parsable, &chunk->thunks, NULL)) goto L0003;
                    goto L0002;
                L0003:;
                    ctx->cur = p;
                    pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
                    if (!pcc_apply_rule(ctx, pcc_evaluate_rule_unparsable, &chunk->thunks, NULL)) goto L0004;
                    goto L0002;
                L0004:;
                    ctx->cur = p;
                    pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_parsable(pelmish_context_t *ctx) {
    pcc_thunk_chunk_t *const chunk = pcc_thunk_chunk__create(ctx->auxil);
    chunk->pos = ctx->cur;
    PCC_DEBUG(ctx->auxil, PCC_DBG_EVALUATE, "parsable", ctx->level, chunk->pos, (ctx->buffer.buf + chunk->pos), (ctx->buffer.len - chunk->pos));
    ctx->level++;
    pcc_value_table__resize(ctx->auxil, &chunk->values, 0);
    pcc_capture_table__resize(ctx->auxil, &chunk->capts, 1);
    {
    ...
    L0002:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_functionDefinition, &chunk->thunks, NULL)) goto L0003;
        goto L0001;
    L0003:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
    ...
    {
        pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_parsable_0, 0, 1);
    ...
    ctx->level--;
    PCC_DEBUG(ctx->auxil, PCC_DBG_MATCH, "parsable", ctx->level, chunk->pos, (ctx->buffer.buf + chunk->pos), (ctx->cur - chunk->pos));
    return chunk;
L0000:;
    ctx->level--;
    PCC_DEBUG(ctx->auxil, PCC_DBG_NOMATCH, "parsable", ctx->level, chunk->pos, (ctx->buffer.buf + chunk->pos), (ctx->cur - chunk->pos));
    pcc_thunk_chunk__destroy(ctx->auxil, chunk);
    return NULL;
}
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_unparsable(pelmish_context_t *ctx) {
    ...
    pcc_capture_table__resize(ctx->auxil, &chunk->capts, 1);
    {
        ...
        size_t q;
        {
            ...
            for (i = 0;; i++) {
                const size_t p = ctx->cur;
                const size_t n = chunk->thunks.len;
                if (!pcc_apply_rule(ctx, pcc_evaluate_rule_Non_WS, &chunk->thunks, NULL)) goto L0001;
                if (ctx->cur == p) break;
                continue;
            L0001:;
                ctx->cur = p;
    ...
    {
        pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_unparsable_0, 0, 1);
        thunk->data.leaf.capts.buf[0] = &(chunk->capts.buf[0]);
        thunk->data.leaf.capt0.range.start = chunk->pos;
        thunk->data.leaf.capt0.range.end = ctx->cur;
        pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_Non_WS(pelmish_context_t *ctx) {
    pcc_thunk_chunk_t *const chunk = pcc_thunk_chunk__create(ctx->auxil);
    chunk->pos = ctx->cur;
    PCC_DEBUG(ctx->auxil, PCC_DBG_EVALUATE, "Non_WS", ctx->level, chunk->pos, (ctx->buffer.buf + chunk->pos), (ctx->buffer.len - chunk->pos));
    ctx->level++;
    pcc_value_table__resize(ctx->auxil, &chunk->values, 0);
    pcc_capture_table__resize(ctx->auxil, &chunk->capts, 0);
    {
    ...
    ctx->level--;
    PCC_DEBUG(ctx->auxil, PCC_DBG_MATCH, "Non_WS", ctx->level, chunk->pos, (ctx->buffer.buf + chunk->pos), (ctx->cur - chunk->pos));
    return chunk;
L0000:;
    ctx->level--;
    PCC_DEBUG(ctx->auxil, PCC_DBG_NOMATCH, "Non_WS", ctx->level, chunk->pos, (ctx->buffer.buf + chunk->pos), (ctx->cur - chunk->pos));
    pcc_thunk_chunk__destroy(ctx->auxil, chunk);
    return NULL;
}
